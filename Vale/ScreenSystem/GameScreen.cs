...
namespace Vale.ScreenSystem
{
    ...
    /// <summary>
    /// A screen is a single layer that has update and draw logic, and which can
    /// be combined with other layers to build up a complex menu system. For
    /// instance, the main menu, the options menu, the "are you sure you want to
    /// quit" message box, and the main game itself are all implemented as
    /// screens.
    /// </summary>
    public abstract class GameScreen
    {
        ...
        /// zero (fully active, no transition) to one (transitioned fully off
        /// to nothing).
        /// </summary>
        ...
        /// <summary>
        /// There are two possible reasons why a screen might be transition off.
        /// It could be temporarily going away to make room for another screen
        /// that is on top of it, or it could be going away for good. This
        /// property indicates whether the screen is exiting for real: if set,
        /// the screen will automatically remove itself as soon as the
        /// transition finishes.
        /// </summary>
